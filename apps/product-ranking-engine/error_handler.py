...
class ModelLoadingError(AppException):
    ...
    def __init__(self, message: str, context: Optional[Dict[str, Any]] = None):
        super().__init__(500, message, ErrorCode.MODEL_LOADING_ERROR, context)
...
class PredictionError(AppException):
    ...
    def __init__(self, message: str, context: Optional[Dict[str, Any]] = None):
        super().__init__(500, message, ErrorCode.PREDICTION_ERROR, context)
...
class ErrorHandler:
    ...
    SUGGESTIONS = {
        ...
        ErrorCode.MODEL_LOADING_ERROR: "Model loading failed. Please try again.",
        ErrorCode.FEATURE_EXTRACTION_ERROR: "Feature extraction failed. Please try again.",
        ErrorCode.PREDICTION_ERROR: "Prediction failed. Please try again.",
    ...
    def create_model_loading_error(
        ...
        return ModelLoadingError(message, context)
    ...
    def create_prediction_error(
        ...
        return PredictionError(message, context)
