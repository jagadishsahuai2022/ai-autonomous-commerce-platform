...
class ErrorCode(str, Enum):
    ...
    DATA_ENRICHMENT_ERROR = "DATA_ENRICHMENT_ERROR"
...
class AggregationError(AppException):
    """Aggregation error exception"""

    def __init__(self, message: str, context: Optional[Dict[str, Any]] = None):
        super().__init__(500, message, ErrorCode.AGGREGATION_ERROR, context)
...
class AdapterError(AppException):
    ...
    def __init__(self, message: str, context: Optional[Dict[str, Any]] = None):
        super().__init__(500, message, ErrorCode.ADAPTER_ERROR, context)


class RankingError(AppException):
    """Ranking error exception"""

    def __init__(self, message: str, context: Optional[Dict[str, Any]] = None):
        super().__init__(500, message, ErrorCode.RANKING_ERROR, context)
...
class ErrorHandler:
    ...
    SUGGESTIONS = {
        ...
        ErrorCode.AGGREGATION_ERROR: "Product aggregation failed. Please try again.",
        ErrorCode.ADAPTER_ERROR: "Adapter error occurred. Please try again.",
        ErrorCode.RANKING_ERROR: "Product ranking failed. Please try again.",
    ...
    def create_aggregation_error(
        ...
        """Create aggregation error"""
        return AggregationError(message, context)
    ...
    def create_adapter_error(
        ...
        return AdapterError(message, context)

    @staticmethod
    def create_ranking_error(
        message: str, context: Optional[Dict[str, Any]] = None
    ) -> RankingError:
        """Create ranking error"""
        return RankingError(message, context)
