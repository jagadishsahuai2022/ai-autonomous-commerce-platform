...
export interface DCProductCardProps {
  product: Product;
...
// Backward-compat aliases — keep all previous names working without changes
export type ProductCardProps = DCProductCardProps;
export const ProductCard = DCProductCard;
export const ExternalProductCard = DCProductCard;
export default DCProductCard;
